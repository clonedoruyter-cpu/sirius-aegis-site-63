      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            ...
            <CarouselPrevious className="-left-12 bg-primary text-white border-primary hover:bg-primary/90 shadow-lg" />
            <CarouselNext className="-right-12 bg-primary text-white border-primary hover:bg-primary/90 shadow-lg" />
          </Carousel>
        </div>
      </div>
    </section>
